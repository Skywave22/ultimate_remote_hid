                  ...
                  return Stack(
                    children: [
                      ...layout.components.map((comp) => Positioned(
                            ...
                            child: SizedBox(
                              width: comp.relativeSize.width * constraints.maxWidth,
                              height: comp.relativeSize.height * constraints.maxHeight,
                              child: GestureDetector(
                                onPanUpdate: (details) => layout.isEditMode
                                    ? ref.read(layoutProvider.notifier).updateComponentPosition(
                                        comp.id, details.delta, constraints.biggest)
                                    : null,
                                onTap: () => layout.isEditMode
